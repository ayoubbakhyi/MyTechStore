...
<aside class="mx-auto my-6 w-full max-w-[1180px] rounded-lg border border-line bg-panel/80 p-4 shadow-glow" id="main-content">
    <h3 class="mb-3 text-lg font-black text-white">Back-Office</h3>
    <ul class="flex flex-wrap gap-2">
        <li><a class="inline-flex min-h-9 items-center rounded-md border border-line px-3 py-2 text-sm font-bold text-slate-300 hover:border-cyanx hover:text-cyanx" href="${ctx}/admin">Dashboard</a></li>
        <li><a class="inline-flex min-h-9 items-center rounded-md border border-line px-3 py-2 text-sm font-bold text-slate-300 hover:border-cyanx hover:text-cyanx" href="${ctx}/admin/produits">Produits</a></li>
        <li><a class="inline-flex min-h-9 items-center rounded-md border border-line px-3 py-2 text-sm font-bold text-slate-300 hover:border-cyanx hover:text-cyanx" href="${ctx}/admin/categories">Categories</a></li>
